...
- The system must support local command execution by default for trusted shaping
  and implementation runs, while keeping scout and resident product/architecture
  agents without general shell execution.
